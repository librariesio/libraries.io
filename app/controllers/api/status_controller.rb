...
class Api::StatusController < Api::BulkProjectController
  ...
  def check
    serializer = OptimizedProjectSerializer.new(projects, project_names, internal_key: internal_api_key?, minimal_versions: ActiveModel::Type::Boolean.new.cast(params[:minimal_versions]))
