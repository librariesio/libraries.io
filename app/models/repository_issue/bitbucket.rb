...
module RepositoryIssue
  class Bitbucket < Base
    ...
    def self.fetch_issue(repo_full_name, issue_number, type, _token = nil)
    ...
    def self.create_from_hash(name_with_owner, issue_hash, _token = nil)
      ...
      user = begin
               RepositoryUser.where(host_type: "Bitbucket").find_by_login(issue_hash[:reported_by][:username]) || RepositoryOwner::Bitbucket.download_user_from_host("Bitbucket", issue_hash[:reported_by][:username])
