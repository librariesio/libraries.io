module ProjectSearch
  ...
  included do
    ...
    FIELDS = ['name^2', 'exact_name^2', 'maven_name^2', 'repo_name', 'description', 'homepage', 'language', 'keywords_array', 'normalized_licenses', 'platform']
    ...
    settings index: { number_of_shards: 3, number_of_replicas: 1 } do
      mapping do
        ...
        indexes :maven_name, type: 'string', :index => :not_analyzed, :boost => 2
    ...
    def as_indexed_json(_options = {})
      as_json(methods: [:stars, :repo_name, :exact_name, :maven_name, :contributions_count, :dependent_repos_count]).merge(keywords_array: keywords)
    end
