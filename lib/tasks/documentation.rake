...
namespace :documentation do
  ...
  task package_manager_matrix: :environment do
    puts "| Name  | Website | Main Language | Versions | Dependencies |"
    puts "| ------------- | ------------- | ------------- | ------------- | ------------- |"
    ...
    PackageManager::Base.platforms.each do |platform|
      puts "| #{platform.formatted_name} | #{platform.homepage} | #{platform.default_language} | #{platform::HAS_VERSIONS} | #{platform::HAS_DEPENDENCIES} |"
    end
  end
end
