Rails.application.routes.draw do
  ...
  scope constraints: {host_type: /(github|gitlab|bitbucket)/i}, defaults: { host_type: 'github' } do
    ...
    get '/:host_type/:owner/:name/activities', to: 'repository_activities#show', as: :repository_activities, format: false, constraints: { :name => /[^\/]+/ }
  ...
  get '/:platform/:name/activity', to: 'project_activity#show', as: :project_activity, constraints: { :name => /.*/ }, :defaults => { :format => 'html' }
