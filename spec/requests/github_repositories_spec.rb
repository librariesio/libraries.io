...
describe "GithubRepositoriesController", :vcr do
  ...
  describe "GET /github/:owner/:name", type: :request do
    it "renders successfully when logged out" do
      visit "/github/#{github_repository.full_name}"
  ...
  describe "GET /github/:owner/:name/tags", type: :request do
    it "renders successfully when logged out" do
      visit "/github/#{github_repository.full_name}/tags"
      expect(page).to have_content "#{github_repository.full_name} tags"
    end
  end

  describe "GET /github/:owner/:name/contributors", type: :request do
    it "renders successfully when logged out" do
      visit "/github/#{github_repository.full_name}/contributors"
      expect(page).to have_content "Committers to #{github_repository.full_name}"
    end
  end

  describe "GET /github/:owner/:name/forks", type: :request do
    it "renders successfully when logged out" do
      visit "/github/#{github_repository.full_name}/forks"
      expect(page).to have_content "Repositories forked from #{github_repository.full_name}"
    end
  end
end
