...
describe "WebHooksController", :vcr do
  ...
  describe "GET /github/:owner/:name/web_hooks", type: :request do
    it "denies access when logged out" do
      get repository_web_hooks_path(repository.owner_name, repository.project_name)
    ...
    it "renders successfully for logged in users" do
      login(user)
      visit repository_web_hooks_path(repository.owner_name, repository.project_name)
  ...
  describe "GET /github/:owner/:name/web_hooks/new", type: :request do
    it "denies access when logged out" do
      get new_repository_web_hook_path(repository.owner_name, repository.project_name)
      expect(response).to redirect_to(login_path)
    end
    ...
    it "renders successfully for logged in users" do
      login(user)
      visit new_repository_web_hook_path(repository.owner_name, repository.project_name)
  ...
  describe "GET /github/:owner/:name/web_hooks/:id/edit", type: :request do
    it "denies access when logged out" do
      get edit_repository_web_hook_path(repository.owner_name, repository.project_name, web_hook.id)
      expect(response).to redirect_to(login_path)
    end
    ...
    it "renders successfully for logged in users" do
      login(user)
      visit edit_repository_web_hook_path(repository.owner_name, repository.project_name, web_hook.id)
