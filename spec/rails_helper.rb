...
def project_json_response(projects)
  projects.as_json(only: Project::API_FIELDS, methods: [:package_manager_url, :stars, :forks, :keywords, :latest_stable_release, :latest_download_url, :repository_license], include: {versions: {only: [:number, :published_at, :original_license, :spdx_expression, :researched_at]} })
end
